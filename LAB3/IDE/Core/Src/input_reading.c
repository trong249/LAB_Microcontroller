...
//debouncing
static GPIO_PinState buttonBuffer[N_OF_BUTTONS];
//we define two buffers for debouncing
static GPIO_PinState debounceButtonBuffer1[N_OF_BUTTONS];
static GPIO_PinState debounceButtonBuffer2[N_OF_BUTTONS];
//we define a flag for a button pressed more than 1 second.
static uint8_t flagForButtonPress1s[N_OF_BUTTONS];
